...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            {{--<input type="checkbox" name="" lay-skin="primary" lay-filter="allChoose" id="allChoose" title="全选"/>--}}
            {{--<input type="checkbox" class="layui-unselect header layui-form-checkbox"" name="checkbox" title="quanxuan" lay-skin="primary">--}}
            {{--<div class="layui-unselect layui-form-checkbox layui-form-checked"><span>全选</span><i class="layui-icon layui-icon-ok"></i></div>--}}
        </div>

        <div class="layui-form-item">
            @foreach( $crm_lim_get as $v )
                    <input type="checkbox" name="id" title="{{$v->lim_con}}" lay-skin="primary" value="{{$v->lim_id}}">
            @endforeach
        </div>
...
//            console.log(data);
            ...
            $.ajax({
                type: 'post',
                dataType: "json",
                data: {check_rule:check_rule,role_id:role_id,_token:_token},
                url: "/role_lim_do",
