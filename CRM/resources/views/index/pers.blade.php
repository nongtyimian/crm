...
<div id="switcher">
    <div class="center">
        <ul>
            ...
            <li class="logoTop">
                <a href="http://www.17sucai.com/pins/29392.html">个人日历</a>            <script type="text/javascript">
                jQuery('#output').qrcode({width:150,height: 150,text: window.location.href});
            </script>
            <li class="remove_frame"><a href="/per_list" title="移除框架"></a></li>
        </ul>
    </div>
</div>

<div id="iframe-wrap">
    <iframe id="iframe" src="/per_list" frameborder="0"  width="100%"></iframe>
</div>
