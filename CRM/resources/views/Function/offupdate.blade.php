...
<div class="x-body">
        ...
        <tbody> 
          <tr>
			...
			<td><input type="text" value="{{$res['o_id']}}" name="o_id" readonly></td>
            <td><input type="text" value="{{$res['o_name']}}" name="o_name"></td>
            <td><input type="text" value="{{$res['o_ctime']}}" name="o_ctime" readonly></td>
            <td><input type="text" value="{{$res['o_sale']}}" name="o_sale"></td>
            <td><input type="text" value="{{$res['o_app']}}" name="o_app"></td>
