...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('合同记录','/contract_add')"><i class="layui-icon"></i>签订</button>
        ...
        @foreach($data as $v)
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a title="删除" onclick="member_del(this,'{{$v->ctt_id}}')" href="javascript:;">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>
            </tr>
