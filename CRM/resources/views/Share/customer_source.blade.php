...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('来源添加','/customer_source_add')"><i class="layui-icon"></i>来源</button>
    </xblock>
        ...
        @foreach($data as $v)
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a title="删除" onclick="member_del(this,'{{$v->s_id}}')" href="javascript:;">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>
            </tr>
