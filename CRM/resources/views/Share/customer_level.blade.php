...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('类型添加','/customer_level_add')"><i class="layui-icon"></i>等级</button>
    </xblock>
        ...
        @foreach($data as $v)
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a title="删除" onclick="member_del(this,'{{$v->l_id}}')" href="javascript:;">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>
            </tr>
