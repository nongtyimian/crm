...
<div class="x-body">
        ...
        <tbody> 
          <tr>
			...
			<td><input type="text" value="{{$res['p_id']}}" name="p_id" readonly></td>
            <td><input type="text" value="{{$res['p_name']}}" name="p_name"></td>
			<td><input type="text" value="{{$res['p_price']}}" name="p_price"></td>
            <td><input type="text" value="{{$res['ctime']}}" name="ctime" readonly></td>
            <td><input type="text" value="{{$res['utime']}}" name="utime" readonly></td>
